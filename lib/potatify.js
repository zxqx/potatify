...
export default async function potatify(filepath)
{
  ...
  let outputFilename = parsedFilepath.name + constants.OUTPUT_FILE_SUFFIX + parsedFilepath.ext;
  let outputFilepath = path.join(constants.OUTPUT_DIR, outputFilename);
